...
DEF = LayoutDef(
    ...
    css=(".ly-objectives{padding:6% 8%}"
         ...
         ".ly-objectives .obj-card{background:var(--surface);border-radius:12px;padding:14px 18px;display:flex;gap:14px;align-items:flex-start;box-shadow:0 2px 10px rgba(0,0,0,.05)}"
